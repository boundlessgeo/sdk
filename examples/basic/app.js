        ...
        <div className="mapName">
          <form onSubmit={this.handleSubmit}>
            <div className="mapForm">
              <label htmlFor="nameField">Change Name:</label>
              <input placeholder="Enter new map name" type="text" id="nameField" value={this.state.value} onChange={this.updateMapName} />
              <button className="sdk-btn" type="submit">Change Map Name</button>
            </div>
          </form>
          <div>New Map Name: {store.getState().map.name}</div>
        </div>
      );
    }
  };
